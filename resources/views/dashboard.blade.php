      ...
      <div class="main-panel">
                      ...
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            ...
                            <h3 class="rate-percentage">{{$dashboard['users']}}</h3>
                          </div>
                          <div>
                            <p class="statistics-title">Events</p>
                            <h3 class="rate-percentage">{{$dashboard['events']}}</h3>
                          </div>
                          {{-- <div>
                          ...
                          <div class="d-none d-md-block">
                            <p class="statistics-title">Discounts</p>
                            <h3 class="rate-percentage">{{$dashboard['discounts']}}</h3>
                          </div>
                          <div class="d-none d-md-block">
                            <p class="statistics-title">Services</p>
                            <h3 class="rate-percentage">{{$dashboard['services']}}</h3>
                          </div>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Bali Business Club</span>
