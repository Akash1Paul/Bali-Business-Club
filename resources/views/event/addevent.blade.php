                            ...
                            <form action="{{url('saveevent')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6" id="date">
                                        ...
                                        <input type="date" name="date" id="tbDate" class="form-control" value="{{ old('date') }}" autocomplete="off">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" name="form" id="form" class="form-control" value="{{ old('form') }}" step="2" >
                                    </div>
                                    <div class="col-md-6">
                                        <label for="description">To <span class="text-danger">*</span></label>
                                        <input type="time" name="to" id="to" class="form-control" value="{{ old('to') }}" step="2">
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <label for="name">Address <span class="text-danger">*</span></label>
                                        <textarea name="address" id="address" cols="30" rows="10" class="form-control h-auto">{{ old('address') }}</textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="about" id="about" cols="30" rows="10" class="form-control h-auto">{{ old('about') }}</textarea>
                                    </div>
                                    <div class="col-md-6">
